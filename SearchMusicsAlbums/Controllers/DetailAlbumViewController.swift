...
class DetailAlbumViewController: UIViewController {
    ...
    private let releaseDateLabel = AlbumModelLabelType(type: .albumName)
    ...
    private func setModel() {
        ...
        setImage(urlString: url, imageView: albumLogo)
    }
...
extension DetailAlbumViewController {
    ...
    private func setConstraints() {
        ...
        [albumNameLabel, artistNameLabel, releaseDateLabel, trackCountLabel].forEach {
